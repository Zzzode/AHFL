...
示例源码可从 [refund_audit_core_v0_1.ahfl](../../examples/refund_audit_core_v0_1.ahfl) 开始阅读。完整语法以 [core-language-v0.1.zh.md](../spec/core-language-v0.1.zh.md) 为准。
...
项目输入和 package authoring 的具体命令见 [CLI 工作流](./user-guide-cli-v0.1.zh.md) 与 [执行与包指南](./user-guide-execution-v0.1.zh.md)。
