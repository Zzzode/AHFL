...
本文说明 AHFL 如何从源码进入 package authoring、execution plan、mock dry run、runtime artifact 和真实 LLM execution。命令语法以 [CLI 工作流](./user-guide-cli-v0.1.zh.md) 为准。
...
7. 进入 [保障与生产证据指南](./user-guide-assurance-v0.1.zh.md) 的 assurance、formal、store 和 provider 门禁。
