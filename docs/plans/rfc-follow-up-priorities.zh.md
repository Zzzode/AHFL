...
1. RFC 0003 后续 pattern usefulness matrix。
   ...
   - 剩余核心工作：future destructuring snippet/editing UX 继续消费 typed pattern HIR；range usefulness 需等待 range pattern syntax 被接受后再做，不预留 placeholder code。
