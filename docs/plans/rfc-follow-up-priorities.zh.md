...
1. RFC 0003 后续 pattern usefulness matrix。
   ...
   - 剩余核心工作：一等 typed pattern HIR、非 Bool open literal/range usefulness、if-let/optional narrowing flow integration、完整 pattern diagnostic code taxonomy、LSP quick fix。
