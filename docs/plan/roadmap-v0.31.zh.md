...
- [x] M0 冻结 local harness sandbox scope
- [x] M1 定义 execution request / record model
- [x] M2 实现 test-only harness runner
- [x] M3 覆盖 timeout、nonzero exit、blocked source、sandbox denial
- [x] M4 建立 CLI、golden、ASan CI 标签
