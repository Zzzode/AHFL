...
- [ ] M0 冻结 production readiness scope
- [ ] M1 定义 readiness evidence model
- [ ] M2 汇总 security / recovery / compatibility / observability evidence
- [ ] M3 定义 blocking issue 与 release gate
