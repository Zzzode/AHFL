...
- [ ] M0 冻结 production config validation scope
- [ ] M1 定义 config bundle validation input / output model
- [ ] M2 实现 provider、secret handle、endpoint 与 env binding 校验
- [ ] M3 输出 redacted validation report 与 blocking summary
