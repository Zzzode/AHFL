...
AHFL_DEFINE_PROVIDER_STEP_1(build_provider_execution_audit_event_for_cli,
                            ProviderExecutionAuditEvent,
                            FailureTaxonomyReport,
                            build_provider_execution_audit_event,
                            event)

AHFL_DEFINE_PROVIDER_STEP_1(build_provider_telemetry_summary_for_cli,
                            ProviderTelemetrySummary,
                            ExecutionAuditEvent,
                            build_provider_telemetry_summary,
                            summary)

AHFL_DEFINE_PROVIDER_STEP_1(build_provider_operator_review_event_for_cli,
                            ProviderOperatorReviewEvent,
                            TelemetrySummary,
                            build_provider_operator_review_event,
                            review)

AHFL_DEFINE_PROVIDER_STEP_1(build_provider_compatibility_test_manifest_for_cli,
                            ProviderCompatibilityTestManifest,
                            OperatorReviewEvent,
                            build_provider_compatibility_test_manifest,
                            manifest)

AHFL_DEFINE_PROVIDER_STEP_1(build_provider_fixture_matrix_for_cli,
                            ProviderFixtureMatrix,
                            CompatibilityTestManifest,
                            build_provider_fixture_matrix,
                            matrix)

AHFL_DEFINE_PROVIDER_STEP_2(build_provider_compatibility_report_for_cli,
...
AHFL_DEFINE_PROVIDER_STEP_1(build_provider_registry_for_cli,
                            ProviderRegistry,
                            CompatibilityReport,
                            build_provider_registry,
                            registry)

AHFL_DEFINE_PROVIDER_STEP_1(build_provider_selection_plan_for_cli,
                            ProviderSelectionPlan,
                            Registry,
                            build_provider_selection_plan,
                            plan)

AHFL_DEFINE_PROVIDER_STEP_1(build_provider_capability_negotiation_review_for_cli,
...
build_provider_conformance_report_for_cli(const ahfl::ir::Program & /*program*/,
