...
constexpr CommandSpec kCommandSpecs[] = {
    ...
    {CommandKind::DumpAst, "dump-ast", 1, 0, 38},
    {CommandKind::DumpTypes, "dump-types", 3, 1, 37},
    ...
    {CommandKind::EmitDurableStoreImportProviderRecoveryHandoff,
     ...
     45,
     25},
    {CommandKind::EmitSchedulerReview, "emit-scheduler-review", 36, 33, 31, 8, 26},
    {CommandKind::EmitRuntimeSession, "emit-runtime-session", 37, 34, 32, 9, 27},
    {CommandKind::EmitDryRunTrace, "emit-dry-run-trace", 38, 35, 33, 10, 28},
    {CommandKind::EmitPackageReview, "emit-package-review", 39, 36, 34, 11},
    {CommandKind::EmitSummary, "emit-summary", 40, 37, 35},
    {CommandKind::EmitSmv, "emit-smv", 41, 38, 36},
};
