...
constexpr CommandSpec kCommandSpecs[] = {
    ...
    {CommandKind::EmitDurableStoreImportProviderWriteCommitReview,
     ...
     80,
     60},
    {CommandKind::EmitSchedulerReview, "emit-scheduler-review", 71, 68, 66, 8, 61},
    {CommandKind::EmitRuntimeSession, "emit-runtime-session", 72, 69, 67, 9, 62},
    {CommandKind::EmitDryRunTrace, "emit-dry-run-trace", 73, 70, 68, 10, 63},
    {CommandKind::EmitPackageReview, "emit-package-review", 74, 71, 69, 11},
    {CommandKind::EmitSummary, "emit-summary", 75, 72, 70},
    {CommandKind::EmitSmv, "emit-smv", 76, 73, 71},
};
