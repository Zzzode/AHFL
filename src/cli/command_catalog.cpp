...
constexpr CommandSpec kCommandSpecs[] = {
    ...
    {CommandKind::DumpAst, "dump-ast", 1, 0, 67},
    {CommandKind::DumpTypes, "dump-types", 3, 1, 66},
    ...
    {CommandKind::EmitDurableStoreImportProviderSdkMockAdapterReadiness,
     ...
     74,
     54},
    {CommandKind::EmitSchedulerReview, "emit-scheduler-review", 65, 62, 60, 8, 55},
    {CommandKind::EmitRuntimeSession, "emit-runtime-session", 66, 63, 61, 9, 56},
    {CommandKind::EmitDryRunTrace, "emit-dry-run-trace", 67, 64, 62, 10, 57},
    {CommandKind::EmitPackageReview, "emit-package-review", 68, 65, 63, 11},
    {CommandKind::EmitSummary, "emit-summary", 69, 66, 64},
    {CommandKind::EmitSmv, "emit-smv", 70, 67, 65},
};
