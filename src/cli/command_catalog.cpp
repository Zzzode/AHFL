...
constexpr CommandSpec kCommandSpecs[] = {
    ...
    {CommandKind::DumpAst, "dump-ast", 1, 0, 56},
    {CommandKind::DumpTypes, "dump-types", 3, 1, 55},
    ...
    {CommandKind::EmitDurableStoreImportProviderConfigReadiness,
     ...
     63,
     43},
    {CommandKind::EmitSchedulerReview, "emit-scheduler-review", 54, 51, 49, 8, 44},
    {CommandKind::EmitRuntimeSession, "emit-runtime-session", 55, 52, 50, 9, 45},
    {CommandKind::EmitDryRunTrace, "emit-dry-run-trace", 56, 53, 51, 10, 46},
    {CommandKind::EmitPackageReview, "emit-package-review", 57, 54, 52, 11},
    {CommandKind::EmitSummary, "emit-summary", 58, 55, 53},
    {CommandKind::EmitSmv, "emit-smv", 59, 56, 54},
};
