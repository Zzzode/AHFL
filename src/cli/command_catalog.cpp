...
constexpr CommandSpec kCommandSpecs[] = {
    ...
    {CommandKind::DumpAst, "dump-ast", 1, 0, 42},
    {CommandKind::DumpTypes, "dump-types", 3, 1, 41},
    ...
    {CommandKind::EmitDurableStoreImportProviderRuntimeReadiness,
     ...
     49,
     29},
    {CommandKind::EmitSchedulerReview, "emit-scheduler-review", 40, 37, 35, 8, 30},
    {CommandKind::EmitRuntimeSession, "emit-runtime-session", 41, 38, 36, 9, 31},
    {CommandKind::EmitDryRunTrace, "emit-dry-run-trace", 42, 39, 37, 10, 32},
    {CommandKind::EmitPackageReview, "emit-package-review", 43, 40, 38, 11},
    {CommandKind::EmitSummary, "emit-summary", 44, 41, 39},
    {CommandKind::EmitSmv, "emit-smv", 45, 42, 40},
};
