...
constexpr CommandSpec kCommandSpecs[] = {
    ...
    {CommandKind::DumpAst, "dump-ast", 1, 0, 48},
    {CommandKind::DumpTypes, "dump-types", 3, 1, 47},
    ...
    {CommandKind::EmitDurableStoreImportProviderLocalHostExecutionReceiptReview,
     ...
     55,
     35},
    {CommandKind::EmitSchedulerReview, "emit-scheduler-review", 46, 43, 41, 8, 36},
    {CommandKind::EmitRuntimeSession, "emit-runtime-session", 47, 44, 42, 9, 37},
    {CommandKind::EmitDryRunTrace, "emit-dry-run-trace", 48, 45, 43, 10, 38},
    {CommandKind::EmitPackageReview, "emit-package-review", 49, 46, 44, 11},
    {CommandKind::EmitSummary, "emit-summary", 50, 47, 45},
    {CommandKind::EmitSmv, "emit-smv", 51, 48, 46},
};
