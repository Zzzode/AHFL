...
constexpr CommandSpec kCommandSpecs[] = {
    ...
    {CommandKind::DumpAst, "dump-ast", 1, 0, 46},
    {CommandKind::DumpTypes, "dump-types", 3, 1, 45},
    ...
    {CommandKind::EmitDurableStoreImportProviderHostExecutionReadiness,
     ...
     53,
     33},
    {CommandKind::EmitSchedulerReview, "emit-scheduler-review", 44, 41, 39, 8, 34},
    {CommandKind::EmitRuntimeSession, "emit-runtime-session", 45, 42, 40, 9, 35},
    {CommandKind::EmitDryRunTrace, "emit-dry-run-trace", 46, 43, 41, 10, 36},
    {CommandKind::EmitPackageReview, "emit-package-review", 47, 44, 42, 11},
    {CommandKind::EmitSummary, "emit-summary", 48, 45, 43},
    {CommandKind::EmitSmv, "emit-smv", 49, 46, 44},
};
