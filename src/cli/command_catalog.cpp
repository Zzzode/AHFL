...
constexpr CommandSpec kCommandSpecs[] = {
    ...
    {CommandKind::DumpAst, "dump-ast", 1, 0, 44},
    {CommandKind::DumpTypes, "dump-types", 3, 1, 43},
    ...
    {CommandKind::EmitDurableStoreImportProviderSdkHandoffReadiness,
     ...
     51,
     31},
    {CommandKind::EmitSchedulerReview, "emit-scheduler-review", 42, 39, 37, 8, 32},
    {CommandKind::EmitRuntimeSession, "emit-runtime-session", 43, 40, 38, 9, 33},
    {CommandKind::EmitDryRunTrace, "emit-dry-run-trace", 44, 41, 39, 10, 34},
    {CommandKind::EmitPackageReview, "emit-package-review", 45, 42, 40, 11},
    {CommandKind::EmitSummary, "emit-summary", 46, 43, 41},
    {CommandKind::EmitSmv, "emit-smv", 47, 44, 42},
};
