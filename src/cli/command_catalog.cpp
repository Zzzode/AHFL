...
constexpr CommandSpec kCommandSpecs[] = {
    ...
    {CommandKind::EmitDurableStoreImportReceiptPersistenceResponseReview,
     ...
     41,
     21},
    {CommandKind::EmitSchedulerReview, "emit-scheduler-review", 32, 29, 27, 8, 22},
    {CommandKind::EmitRuntimeSession, "emit-runtime-session", 33, 30, 28, 9, 23},
    {CommandKind::EmitDryRunTrace, "emit-dry-run-trace", 34, 31, 29, 10, 24},
    {CommandKind::EmitPackageReview, "emit-package-review", 35, 32, 30, 11},
    {CommandKind::EmitSummary, "emit-summary", 36, 33, 33},
    {CommandKind::EmitSmv, "emit-smv", 37, 34, 34},
};
