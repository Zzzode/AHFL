...
constexpr CommandSpec kCommandSpecs[] = {
    ...
    {CommandKind::DumpAst, "dump-ast", 1, 0, 40},
    {CommandKind::DumpTypes, "dump-types", 3, 1, 39},
    ...
    {CommandKind::EmitDurableStoreImportProviderDriverReadiness,
     ...
     47,
     27},
    {CommandKind::EmitSchedulerReview, "emit-scheduler-review", 38, 35, 33, 8, 28},
    {CommandKind::EmitRuntimeSession, "emit-runtime-session", 39, 36, 34, 9, 29},
    {CommandKind::EmitDryRunTrace, "emit-dry-run-trace", 40, 37, 35, 10, 30},
    {CommandKind::EmitPackageReview, "emit-package-review", 41, 38, 36, 11},
    {CommandKind::EmitSummary, "emit-summary", 42, 39, 37},
    {CommandKind::EmitSmv, "emit-smv", 43, 40, 38},
};
