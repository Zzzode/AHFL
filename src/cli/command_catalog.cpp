...
constexpr CommandSpec kCommandSpecs[] = {
    ...
    {CommandKind::EmitDurableStoreImportProviderProductionReadinessReport,
     ...
     97,
     77},
    {CommandKind::EmitSchedulerReview, "emit-scheduler-review", 88, 85, 91, 8, 78},
    {CommandKind::EmitRuntimeSession, "emit-runtime-session", 89, 86, 92, 9, 79},
    {CommandKind::EmitDryRunTrace, "emit-dry-run-trace", 90, 87, 93, 10, 80},
    {CommandKind::EmitPackageReview, "emit-package-review", 91, 88, 94, 11},
    {CommandKind::EmitSummary, "emit-summary", 92, 89, 95},
    {CommandKind::EmitSmv, "emit-smv", 93, 90, 96},
};
