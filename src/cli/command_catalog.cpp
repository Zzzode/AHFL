...
constexpr CommandSpec kCommandSpecs[] = {
    ...
    {CommandKind::DumpAst, "dump-ast", 1, 0, 36},
    {CommandKind::DumpTypes, "dump-types", 3, 1, 35},
    ...
    {CommandKind::EmitDurableStoreImportRecoveryPreview,
     ...
     43,
     23},
    {CommandKind::EmitSchedulerReview, "emit-scheduler-review", 34, 31, 29, 8, 24},
    {CommandKind::EmitRuntimeSession, "emit-runtime-session", 35, 32, 30, 9, 25},
    {CommandKind::EmitDryRunTrace, "emit-dry-run-trace", 36, 33, 31, 10, 26},
    {CommandKind::EmitPackageReview, "emit-package-review", 37, 34, 32, 11},
    {CommandKind::EmitSummary, "emit-summary", 38, 35, 33},
    {CommandKind::EmitSmv, "emit-smv", 39, 36, 34},
};
