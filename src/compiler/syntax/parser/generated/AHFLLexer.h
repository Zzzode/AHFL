...
public:
  enum {
    ...
    DURATION_LITERAL = 115, DECIMAL_LITERAL = 116, FLOAT_LITERAL = 117, 
    INT_LITERAL = 118, STRING_LITERAL = 119, IDENT = 120, DOC_COMMENT = 121, 
    LINE_COMMENT = 122, BLOCK_COMMENT = 123, WS = 124
  };
