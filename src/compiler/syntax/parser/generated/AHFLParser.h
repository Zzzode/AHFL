...
public:
  enum {
    ...
    T__134 = 135, T__135 = 136, DURATION_LITERAL = 137, DECIMAL_LITERAL = 138,
    FLOAT_LITERAL = 139, INT_LITERAL = 140, BACKSLASH = 141, STRING_LITERAL = 142,
    IDENT = 143, DOC_COMMENT = 144, LINE_COMMENT = 145, BLOCK_COMMENT = 146,
    WS = 147
  };
