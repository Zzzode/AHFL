#include "backends/pipeline/store_import_descriptor.hpp"
...
class StoreImportDescriptorJsonPrinter final : private PipelineJsonHelpers {
  public:
    explicit StoreImportDescriptorJsonPrinter(std::ostream &out) : PipelineJsonHelpers(out) {}
